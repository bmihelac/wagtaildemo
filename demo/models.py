...
from wagtail.wagtailcore.blocks import TextBlock, StructBlock, StreamBlock, FieldBlock, CharBlock, RichTextBlock, RawHTMLBlock, DateBlock
...
class DemoStreamBlock(StreamBlock):
    ...
    my_date = DateBlock(
        label='Date block with custom format',
        format='%d/%m/%y',
        input_formats=['%d/%m/%y']
    )
